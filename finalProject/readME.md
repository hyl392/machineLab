...
**Discuss what other components or materials you will need when the project is assembled:** I need a base for both of my mechanisms, scrap wood pieces will do. I've already made holes in the base of my mechanisms for my mechanisms to be attached to the wooden base pieces. I will also need a piece of cloth for Mechanism 2 for the legs of my person. While the ball is being spun on the finger, the legs of the player would also be moving, simulating that she is running/moving. I also need to have a structure/base to hold up my motors. I already have stepper motor holders designed in but would obviously need to ground them down.
